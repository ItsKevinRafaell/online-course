...
@section('content')
                ...
                <x-card.card title="Create or Edit Materi">
                    <form action="{{ route('materi.store', $series->slug) }}" method="POST">
                        ...
                        <div id="point-form">
                            ...
                            <x-form.textarea title="Point Content" name="points[0][content]" 
                                id="point-content-0" placeholder="Enter point content">{{ old('points.0.content') }}</x-form.textarea>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Muat data point saat point dipilih
            ...
            addPointButton.addEventListener('click', function () {
                ...
                `;
                document.getElementById('point-form').insertAdjacentHTML('beforeend', newPointHtml);
                pointIndex++;
            });
        });
    </script>
